...
const Schema: z.ZodType<Prisma.SubtaskUncheckedUpdateManyWithoutParentNestedInput> =
	z
		.object({
			create: z
				.union([
			...
			updateMany: z
				.union([
					z.lazy(
						() => SubtaskUpdateManyWithWhereWithoutParentInputObjectSchema
					),
					z
						.lazy(
							() => SubtaskUpdateManyWithWhereWithoutParentInputObjectSchema
...
export const SubtaskUncheckedUpdateManyWithoutParentNestedInputObjectSchema =
	Schema;
